...
<body>
  ...
  <main id="main">
        ...
        <div class="row">
          <div class="col-lg-4 d-flex align-items-stretch">
            <div class="content">
              ...
              <p>
                MedCare is the connection between the patient with the doctors, pharmacy, and ambulance.
                It will be an easy way to get necessary medicines, doctor advice, and an ambulance when its need.
              ...
              <div class="row">
                <div class="col-xl-4 d-flex align-items-stretch">
                  <div class="icon-box mt-4 mt-xl-0">
                    ...
                    <p>If you need the excellent servicess, try Medcare.</p>
                  </div>
                </div>
                <div class="col-xl-4 d-flex align-items-stretch">
                  <div class="icon-box mt-4 mt-xl-0">
                    <i class="fas fa-user-md"></i>
                    <h4>Finest Doctors</h4>
                    <p>We provide the finest doctors in our MedCare Service.</p>
                  </div>
                </div>
                <div class="col-xl-4 d-flex align-items-stretch">
                  <div class="icon-box mt-4 mt-xl-0">
                    ...
                    <p>MedCare provides a secure environment to their patients.</p>
                  </div>
                </div>
              </div>
            </div>
    ...
    <div class="container box">
      <br />
      <h2 align="center">Book an Ambulance</h2><br />
      <?php echo $message; ?>
      <form method="post" id="register_form">
        ...
        <li class="nav-item">
          <a class="nav-link inactive_tab1" id="list_personal_details" style="border:1px solid #ccc">Ambulance Details</a>
        </li>
        <li class="nav-item">
        ...
        <div class="tab-pane active" id="login_details">
          ...
          <div class="panel-body">
            ...
            <input type="text" name="email" id="email" value="<?php echo $session_email;?>" class="form-control" />
        ...
        <div class="tab-pane fade" id="personal_details">
          <div class="panel panel-default">
          <div class="panel-heading">Ambulance & Hospital Details</div>
          <div class="panel-body">
            <div class="form-group">
            <label>Select Ambulance Company</label>
            ...
            <select name="first_name" id="first_name" class="form-select">
                ...
                <?php
                  while($row=mysqli_fetch_array($ambulance)){
                    echo "<option>".$row['ambulance_name']."<br></option>";
                  }
                ?>
              </select>
            ...
            <select name="last_name" id="last_name" class="form-select">
                ...
                <?php
                  while($row=mysqli_fetch_array($hospital)){
                    echo "<option>".$row['hospital_name']."<br></option>";
                  }
                ?>
              </select>
            ...
            <label class="radio-inline">
              <input type="radio" name="gender" value="north" checked> North
            </label>
            <label class="radio-inline">
        ...
        <div class="tab-pane fade" id="contact_details">
          ...
          <div class="panel-body">
            ...
            <button type="button" name="btn_contact_details" id="btn_contact_details" class="btn btn-success btn-lg">Book</button>
            </div>
            <br />
          </div>
          </div>
              ...
              <select name="department" id="department" class="form-select">
                ...
                <?php
                  while($row=mysqli_fetch_array($department)){
                    echo "<option>".$row['department_name']."<br></option>";
                  }
                ?>
              </select>
              <div class="validate"></div>
              ...
              <select name="doctor" id="doctor" class="form-select">
                ...
                <?php
                  while($row=mysqli_fetch_array($doctor)){
                    echo "<option>".$row['doctor_name']."<br></option>";
                  }
                ?>
      ...
      <div class="container">
        <div class="row mt-5">
          ...
          <div class="col-lg-8 mt-5 mt-lg-0">
            ...
            <!-- <form action="home.php" method="post" role="form" class="php-email-form"> -->
            <form action="home.php" method="post" class="email-form">
              <div class="row">
