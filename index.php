...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      // }
      ?>
      <a href="./login.php" class="nav-link scrollto">Login/Register</a>
  ...
  <main id="main">
      ...
      <div class="container">
        ...
        <div class="section-title">
          ...
          <div class="col-lg-9 mt-8 mt-lg-0">
            ...
            <img src="assets/img/ambulance.png" alt="" class="img-fluid">
            <!-- <button type="button" class="btn btn-primary btn-lg pull-right">Book an Ambulance</button> -->
          </div>
        </div>
      </div>
    ...
    <section id="appointment" class="appointment section-bg">
      <div class="container">
        ...
        <form action="forms/appointment.php" method="post" role="form" class="email-form php-email-form">
          <div class="row">
      ...
      <div class="container">
        <div class="row mt-5">
          ...
          <div class="col-lg-8 mt-5 mt-lg-0">
            ...
            <form action="forms/contact.php" method="post" role="form" class="email-form php-email-form">
              <div class="row">
